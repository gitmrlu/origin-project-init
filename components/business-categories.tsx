        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">
              AI learned what we wrote. It never learned what we do.
            </h2>
            <p className="mt-6 text-lg text-gray-600">
              AI is capped because it lacks procedural data. Existing datasets are documents and chats, not workflows. 
              Task farms and synthetic data are expensive, low-signal, and miss human nuance.
            </p>
            <blockquote className="mt-8 text-xl italic text-gray-700">
              "Expertise is not in the manual. It's in the motion, the pause, the sequence."
            </blockquote>
          </div>
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">
              We turn practice into structured data.
            </h2>
            <p className="mt-6 text-lg text-gray-600">
              ArkAngel lives in your browser and telehealth calls. Captures speech, clicks, and workflows with consent. 
              On device redaction and privacy controls built in. Provides real time copilots for clinicians and professionals. 
              Creates structured workflow datasets for AI labs.
            </p>
          </div>
          {/* Tab panels */}
