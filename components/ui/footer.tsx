        ...
        >
          ...
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-sm text-gray-600">
              &copy; ArkAngel - All rights reserved.
            </div>
          </div>
            ...
            <ul className="flex gap-1">
              <li>
                <Link
                  ...
                  href="https://x.com/Cookiesarefunnn"
                  target="_blank"
              ...
              <li>
                <Link
                  className="flex items-center justify-center text-blue-500 transition hover:text-blue-600"
                  href="https://medium.com/@shanunnadav/ending-the-plateau-a-manifesto-for-downloading-all-8-billion-brains-for-ai-to-train-on-1eb9802d9137"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Medium"
                >
