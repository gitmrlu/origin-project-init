        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              Better data. Safer AI. Free copilots.
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Free Copilot for Professionals</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Real time prep, context, and draft notes. Zero cost.
                Get intelligent assistance while you work.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                On device redaction. You control your data. Hard opt out.
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Structured Workflow Data</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                DOM states, timestamps, speech alignment — drop straight into pipelines.
                Real expert workflows, not synthetic data.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Zero telemetry option for regulated domains.
                Built for healthcare, finance, and sensitive environments.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Live workflow capture during browser sessions and telehealth calls.
                Continuous data collection keeps datasets fresh and relevant.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>AI Lab Integration</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Direct integration with AI training pipelines. Access structured datasets
                from real expert workflows. Cheaper, higher signal than synthetic data.
              </p>
            </article>
          </div>
        </div>
